...
<body>
    ...
    <table border=0 width=100% style="text-align:center; margin-top: 20px;">
      <tbody>
        <tr>
          <h3 style="text-transform: uppercase">Laporan Penerimaan Obat</h3>
          <span>Kode: <?= $penerimaan[0]->kd_penerimaan ?></span>
        </tr>
      </tbody>
    </table>
    ...
    <table border=0 width=100% cellpadding=2 cellspacing=0 style="margin-top: 20px; font-size: 10pt;">
      <tbody>
        <tr>
          <td style="text-transform: uppercase" width=10%><strong>No SBBK</strong></td>
          <td style="text-transform: uppercase" width=90%><strong>: <?= $penerimaan[0]->no_sbbk ?></strong></td>
        </tr>
        <tr>
          <td style="text-transform: uppercase" width=10%><strong>Tanggal</strong></td>
          <td style="text-transform: uppercase" width=90%><strong>: <?= $tanggalPenerimaan ?></strong></td>
        </tr>
      </tbody>
    </table>
    ...
    <table border=1 width=100% cellpadding=4 cellspacing=0 style="margin-top: 30px; font-size: 9pt;">
        ...
        <tbody>
          <?php foreach ($penerimaan as $key => $data) :?>
            <tr>
              <td><?= $key + 1; ?></td>
              <td><?= $data->kd_obat; ?></td>
              <td><?= $data->nama; ?></td>
    ...
    <table border=0 width=60% cellpadding=2 cellspacing=0 style="margin-top: 30px; font-size: 10pt;">
      <tbody>
        <tr>
          ...
          <td width=90%>: <?= $penerimaan[0]->keterangan ?></td>
        </tr>
      </tbody>
    </table>
